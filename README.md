...
2. WinMergeを起動して「プラグイン」を「自動展開」に変更します。  
![picture 3](images/7589CB7B-A159-40D0-B9FA-4B4895FBB229.png)  
3. 本アプリを再起動します。
4. 本アプリと同じフォルダにある「appSettings.json」をメモ帳等で開きます。
5. ExcelDiffToolPath、WordDiffToolPath、PowerPointDiffToolPathを適切なパスに書き換えます。
6. 本アプリを再起動します。
